		...
		<?php 
			...
			while ($resr1 = mysqli_fetch_array($queryr1)) { 
				...
				<div class="col-md-6" style="text-align: center;"><br><br>
					...
					<div class="container-fluid justify-content-center">
						<a href="singlesuite.php" class="learn-more-btn">Learn More</a>
					</div>
				</div>
				<?php
			}
		...
		<?php 
			...
			while ($resr2 = mysqli_fetch_array($queryr2)) { 
				...
				<div class="col-md-6" style="text-align: center;"><br><br>
					...
					<div class="container-fluid justify-content-center">
						<a href="regulardeluxe.php" class="learn-more-btn">Learn More</a>
					</div>
				</div>
				<?php
			}
...
<div class="container bg-transparent">
	<div class="row">
		<div class="col-md-6" style="text-align: center;"><br><br>
			...
			<div class="container-fluid justify-content-center">
				<a href="doubledeluxe.php" class="learn-more-btn">Learn More</a>
			</div>
		</div>
		<?php
			}
...
<div class="container bg-transparent">
	<div class="row">
		...
		<div class="col-md-6" style="text-align: center;"><br><br>
			...
			<div class="container-fluid justify-content-center">
				<a href="executivesuit.php" class="learn-more-btn">Learn More</a>
			</div>
		</div>
		<?php
			}
...
<div class="container bg-transparent">
	<div class="row">
		<div class="col-md-6" style="text-align: center;"><br><br>
			...
			<div class="container-fluid justify-content-center">
				<a href="familysuit.php" class="learn-more-btn">Learn More</a>
			</div>
		</div>
		<?php
			}
...
<div class="container bg-transparent">
	<div class="row">
		...
		<div class="col-md-6" style="text-align: center;"><br><br>
			...
			<div class="container-fluid justify-content-center">
				<a href="premiumsuite.php" class="learn-more-btn">Learn More</a>
			</div>
		</div>
		<?php
			}
...
<div class="container bg-transparent">
	<div class="row">
		<div class="col-md-6" style="text-align: center;"><br><br>
			...
			<div class="container-fluid justify-content-center">
				<a href="presidentialsuite.php" class="learn-more-btn">Learn More</a>
			</div>
		</div>
		<?php
			}
